      ...
      <Container >
        <div className={style.container}>
          <div className={style.category}>
            <h2 className={classnames(style.title,style.categoryTitle)}>Каталог</h2>
          ...
          <div className={style.social}>
            <h2 className={classNames(style.title,style.socialTitle)}>Связаться с нами</h2>
            <p className={style.socialSubtitle}>Контакты и адреса магазинов</p>
            <ul className={style.socialList}>
              <li>
                <a href="#" className={classNames(style.link,style.socialLinkVK)}>
              ...
              <li>
                <a href="#"  className={classNames(style.link,style.socialLinkFB)}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={style.development }></div>
        </div>
      </Container>
    </footer>
  );
