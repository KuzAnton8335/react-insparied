      ...
      <Container>
        <div className={style.container}>
          <div className={style.category}>
            <h2 className={classnames(style.title, style.categoryTitle)}>
              Каталог
            </h2>
          ...
          <div className={style.social}>
            <h2 className={classNames(style.title, style.socialTitle)}>
              Связаться с нами
            </h2>
            ...
            <ul className={style.socialList}>
              <li>
                <a
                  href="#"
                  className={classNames(style.link, style.socialLinkVK)}
                >
                  <svg
                    width="24"
                    height="24"
              ...
              <li>
                <a
                  href="#"
                  className={classNames(style.link, style.socialLinkFB)}
                >
                  <svg
                    width="24"
                    height="24"
          ...
          <div className={style.contacts}>
            ...
            <a href="tel:89304902620" className={style.link}>
              8 930 490 26 20
            </a>
          </div>
